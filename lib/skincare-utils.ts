...
export function getSkinPhaseInfo(phase: SkincareCyclePhase): SkinPhaseInfo {
  const phaseInfoMap: Record<SkincareCyclePhase, SkinPhaseInfo> = {
    menstrual: {
      ...
      uiCopy:
        "Your skin may feel more sensitive today \u2014 keep things simple.",
      routineFocus: [
        "Gentle cleanser",
        "Hydrating moisturizer",
        "Minimal or no actives",
      ],
    },
    follicular: {
      phase: "follicular",
    ...
    luteal: {
      ...
      uiCopy:
        "Breakouts around this phase are common \u2014 be kind to your skin.",
      routineFocus: [
        "Non-irritating acne care",
        "Barrier protection",
        ...
        steps: [
          {
            name: "Cleanse",
            description:
              "Use a gentle, cream-based cleanser. Avoid anything foaming or stripping.",
            productType: "Cream cleanser",
          },
          {
            name: "Tone (Optional)",
            description:
              "A hydrating floral water or mist to wake up the skin.",
            productType: "Rose water or facial mist",
          },
          {
            name: "Moisturize",
            description:
              "Apply a rich, hydrating moisturizer. Your skin needs extra nourishment right now.",
            productType: "Hydrating moisturizer",
          },
          {
            name: "Protect",
            description:
              "Apply SPF even on low-energy days. A mineral sunscreen is gentle on sensitive skin.",
        ...
        steps: [
          {
            name: "Cleanse",
            description:
              "Gently remove the day. A micellar water or oil cleanser works well.",
            productType: "Micellar water or oil cleanser",
          },
          {
            name: "Hydrate",
            description:
              "Layer a hydrating serum or essence before your moisturizer for extra comfort.",
            productType: "Hydrating serum",
          },
          {
            name: "Treat (Optional)",
            description:
              "If you have a sheet mask, this is the perfect time for a 10-minute relax.",
            productType: "Soothing sheet mask",
          },
          {
            name: "Moisturize",
            description:
              "Seal everything in with a rich night cream or sleeping mask.",
    ...
    follicular: [
      {
        ...
        steps: [
          ...
          },
          {
            name: "Brighten",
            description:
              "Vitamin C serum works best in this phase to boost that natural glow.",
          ...
          },
          {
            name: "Protect",
            description:
              "Daily SPF. Your skin can handle broader spectrum options now.",
            productType: "SPF",
          },
        ],
      },
        ...
        steps: [
          {
            name: "Cleanse",
            description:
              "Double cleanse if you wore sunscreen or makeup. Otherwise, a single gentle cleanse is fine.",
            productType: "Cleansing balm + gel cleanser",
          },
          {
            name: "Moisturize",
            description:
              "A nourishing night moisturizer to support your skin while you sleep.",
        ...
        steps: [
          {
            name: "Cleanse",
            description:
              "A gentle gel cleanser to manage extra oil without stripping.",
            productType: "Gel cleanser",
          },
          {
            name: "Tone",
            description: "A pore-refining toner helps manage oil production.",
            productType: "Balancing toner",
          },
          {
            name: "Balance",
            description:
              "A lightweight, oil-free moisturizer or a hydrating serum.",
            productType: "Oil-free moisturizer",
          },
          {
            name: "Protect",
            description:
              "SPF is especially important now. Choose a lightweight, non-comedogenic formula.",
        ...
        steps: [
          {
            name: "Double Cleanse",
            description:
              "Start with an oil cleanser to break down SPF/oil, follow with water-based.",
            productType: "Oil cleanser + gel cleanser",
          },
          {
            name: "Treat (optional)",
            description:
              "A gentle clarifying toner or serum if oiliness is noticeable. Skip if skin feels fine.",
            productType: "Clarifying toner",
          },
          {
            name: "Hydrate",
            description:
              "Hyaluronic acid or niacinamide serum to keep skin plump.",
            productType: "Lightweight serum",
          },
          {
            name: "Moisturize",
            description:
              "A light gel moisturizer to hydrate without adding extra oil.",
        ...
        steps: [
          {
            name: "Cleanse",
            description:
              "A soothing, non-foaming cleanser. Avoid anything harsh.",
            productType: "Cream or gel cleanser",
          },
          {
            name: "Soothe",
            description:
              "If breakouts appear, spot treat gently. No picking, no over-treating.",
            productType: "Gentle spot treatment",
          },
          {
            name: "Moisturize",
            description:
              "A barrier-supporting moisturizer helps protect your skin from irritation.",
            productType: "Barrier cream",
          },
          {
            name: "Protect",
            description:
              "SPF daily. Look for formulas that are soothing and non-comedogenic.",
        ...
        steps: [
          {
            name: "Cleanse",
            description:
              "Gentle double cleanse. Let your skin breathe without stripping.",
            productType: "Oil cleanser + gentle wash",
          },
          {
            name: "Clay Mask (Weekly)",
            description:
              "Use a gentle clay mask on congestion-prone areas only (10 mins max).",
            productType: "Gentle clay mask",
          },
          {
            name: "Treat",
            description:
              "A calming serum with ingredients like niacinamide supports the barrier.",
            productType: "Calming serum",
          },
          {
            name: "Moisturize",
            description:
              "Rich moisturizer to repair and support your skin while you rest.",
